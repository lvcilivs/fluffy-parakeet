                ...
                PopupMenuButton(
                    ...
                    itemBuilder: (context) => [
                          PopupMenuItem(
                            ...
                            onTap: () {
                              context.read<TermsAndConditionsBloc>().add(
                                  SelectLanguage(selectedLanguage: 'English'));
                            },
                          ...
                          PopupMenuItem(
                            ...
                            onTap: () {
                              context.read<TermsAndConditionsBloc>().add(
                                  SelectLanguage(selectedLanguage: 'Tamil'));
                            },
                            child: const PopUpMenuLanguage(
                              language: 'Tamil',
                            ),
                          ...
                          PopupMenuItem(
                            ...
                            onTap: () {
                              context.read<TermsAndConditionsBloc>().add(
                                  SelectLanguage(selectedLanguage: 'Telegu'));
                            },
                            child: const PopUpMenuLanguage(
                              language: 'Telegu',
                            ),
                          ...
                          PopupMenuItem(
                            ...
                            onTap: () {
                              context.read<TermsAndConditionsBloc>().add(
                                  SelectLanguage(selectedLanguage: 'Kannada'));
                            },
                            child: const PopUpMenuLanguage(
                              language: 'Kannada',
                            ),
                          ...
                          PopupMenuItem(
                            ...
                            onTap: () {
                              context.read<TermsAndConditionsBloc>().add(
                                  SelectLanguage(selectedLanguage: 'Marathi'));
                            },
                            child: const PopUpMenuLanguage(
                              language: 'Marathi',
                              divider: false,
